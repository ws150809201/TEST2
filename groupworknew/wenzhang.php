<?php
$res=mysqli_connect('localhost','root','123456','yingling');
...
<div id="page" class="">
    ...
    <div class="login-top">
        <div class="container">
            ...
            <div class="user_info_pc pull-right"><a href="#" class="navbar-brand head-link">登陆</a></div>
    ...
    <div class="header-container">
        <ul class="header-nav" id="nav-hide">
            ...
            <ul class="">
                ...
                <li><a class="css2bcc1448c4e52" href="#">同人漫画</a></li>
            </ul>
    ...
    <div class="container outer">
        ...
        <div class="row" id="row-move">
            ...
            <div class="col-xs-12 col-md-6">
                <ul class="list-group articlelist">
                    ...
                    <li class="list-group-item">
                        <div class="articlelist-item-head">
                            <h4 class="update">FGOWiki网站&amp;APP改版预告</h4>

                        </div>
                        <div class="articlelist-item-body">
                            <a href="#">
                            </a>
                            <pre class="helperContent" style="background:none;">3月31日更新标题！详情进展可查阅手册论坛同名帖2楼！ —— 感谢各位的支持，为了更好地服务大家，我们已准备好修复…… 不，不只是这样，经过这几个月的努力，我们…</pre>

                        </div>
                        <div class="articlelist-item-footer">
                            <a class="btn read" href="#">阅读全文</a>
                            <div>
                            </div>
                    ...
                    <li class="list-group-item">
                        <div class="articlelist-item-head">
                            <h4 class="update">如何支持我们：关于Wiki国服FGO的详尽说明</h4>

                        </div>
                        <div class="articlelist-item-body">
                            <a href="#">
                                <img width="800" height="300" src="images/image20161012172227.jpg" class="attachment-full size-full wp-post-image" alt="image20161012172227" srcset="https://fgowiki.com/wp-content/uploads/2016/12/image20161012172227.jpg 800w, https://fgowiki.com/wp-content/uploads/2016/12/image20161012172227-300x113.jpg 300w, https://fgowiki.com/wp-content/uploads/2016/12/image20161012172227-768x288.jpg 768w" sizes="(max-width: 800px) 100vw, 800px">                            </a>
                            <pre class="helperContent" style="background:none;">Q：Wiki服是什么？是一般的渠道服么？ A：Wiki服是由B站官服中分流出来的，相当于渠道服的服务器。与九游、OPPO等代理商的渠道服差别在于，数据和B站官服…</pre>
                    ...
                    <li class="list-group-item">
                        <div class="articlelist-item-head">
                            <h4 class="update">【维护通告】关于服务器遭受恶意攻击</h4>

                        </div>
                        <div class="articlelist-item-body">
                            <a href="#">
                            </a>
                            <pre class="helperContent" style="background:none;">2016.10.16 18:30起遭受不明来路 攻击 导致网站瘫痪 甚至部分页面挂码 程序员大大正在熬夜检查这背后的阴谋 给您带来的不便 我们表示深深的歉意</pre>
                    ...
                    <li class="list-group-item">
                        <div class="articlelist-item-head">
                            <h4 class="update">五色共存端ver1.13.0下载地址</h4>

                        </div>
                        <div class="articlelist-item-body">
                            <a href="#">
                            </a>
                            <pre class="helperContent" style="background:none;">暂以网盘的形式放出，下载地址请见：http://pan.baidu.com/s/1cgecLw</pre>

                        </div>
                        <div class="articlelist-item-footer">
                            <a class="btn read" href="#">阅读全文</a>
                            <div>
                                <a href="#"><span>共存端</span></a>
                            </div>
                    ...
                    <li class="list-group-item">
                        <div class="articlelist-item-head">
                            <h4 class="update">【FGOWIKI】关于共存端的声明</h4>

                        </div>
                        <div class="articlelist-item-body">
                            <a href="#">
                                <img width="2208" height="1242" src="images/7-1.png" class="attachment-full size-full wp-post-image" alt="7" srcset="https://fgowiki.com/wp-content/uploads/2016/07/7-1.png 2208w, https://fgowiki.com/wp-content/uploads/2016/07/7-1-300x169.png 300w, https://fgowiki.com/wp-content/uploads/2016/07/7-1-1024x576.png 1024w" sizes="(max-width: 2208px) 100vw, 2208px">                            </a>
                            <pre class="helperContent" style="background:none;">【此次共存端更新说明】 此次更新的共存端可以覆盖原来的同名共存端版本，做了绕过root检测，直接下载安装即可。但是无法使用谷歌相关服务，比如在游戏中氪金。共存端…</pre>

                        </div>
                        <div class="articlelist-item-footer">
                            <a class="btn read" href="#">阅读全文</a>
                            <div>
                                <a href="#"><span>Fgowiki</span></a>
                                <a href="#"><span>共存端</span></a>
                            </div>
                    ...
                    <li class="list-group-item">
                        <div class="articlelist-item-head">
                            <h4 class="update">【FGOWIKI】〈翻译组 攻略组〉招募计划！</h4>

                        </div>
                        <div class="articlelist-item-body">
                            <a href="#">
                                <img width="1140" height="350" src="images.jpg" class="attachment-full size-full wp-post-image" alt="Banner" srcset="images/Banner.jpg 1140w, https://fgowiki.com/wp-content/uploads/2016/07/Banner-300x92.jpg 300w, https://fgowiki.com/wp-content/uploads/2016/07/Banner-1024x314.jpg 1024w" sizes="(max-width: 1140px) 100vw, 1140px">                            </a>
                            <pre class="helperContent" style="background:none;">观众老爷们好，手册组诚邀有攻略编写才能、日语翻译技能的玩家加入我们手册组，有了你们的加入，FGOwiki才能为FGO全体玩家提供更好的服务！ 【招募明细】 身份…</pre>
                    ...
                    <li class="list-group-item">
                        <div class="articlelist-item-head">
                            <h4 class="update">【重要】关于暂停五色共存端更新的说明</h4>

                        </div>
                        <div class="articlelist-item-body">
                            <a href="#">
                            </a>
                            <pre class="helperContent" style="background:none;">鉴于官方发布的说明————“关于Ver.1.11.0以后 在推荐环境以外运行的相关事项”中提到以下环境无法继续正常使用 ・已经root※的安卓终端 ・越狱※的i…</pre>
                    ...
                    <li class="list-group-item">
                        <div class="articlelist-item-head">
                            <h4 class="update">FgoWiki Ver1.26 Web＆手册  缓存炼成!</h4>

                        </div>
                        <div class="articlelist-item-body">
                            <a href="#">
                            </a>
                            <pre class="helperContent" style="background:none;">修复了很多必要性的Bug并增加了缓存 But太多就不一一列举了 Master》设置》下载英灵 理装 素材离线包 &nbsp; Ps：还有就是大家一直在问为什么汉…</pre>
                    ...
                    <li class="list-group-item">
                        <div class="articlelist-item-head">
                            <h4 class="update">【联交活动预告】FGOWiki×贴吧『Fate/Salted Fish War咸鱼战争』</h4>

                        </div>
                        <div class="articlelist-item-body">
                            <a href="#">
                                <img width="800" height="300" src="images/咸鱼改.png" class="attachment-full size-full wp-post-image" alt="咸鱼改" srcset="images/咸鱼改.png 800w, images/咸鱼改-300x113.png 300w" sizes="(max-width: 800px) 100vw, 800px">                            </a>
                            <pre class="helperContent" style="background:none;">“来自贴吧的不知道多少名酋长带着他的部落为争夺号称能入住欧洲的咸鱼王之名而展开了较量...” “虽说如此，但实际咸鱼王真的能入欧么？非要说的顶着这个名字已经注定…</pre>

                        </div>
                        <div class="articlelist-item-footer">
                            <a class="btn read" href="#">阅读全文</a>
                            <div>
                                <a href="#"><span>咸鱼战争</span></a>
                                <a href="#"><span>活动</span></a>
                                <a href="#"><span>贴吧</span></a>
                            </div>
                    ...
                    <li class="list-group-item">
                        <div class="articlelist-item-head">
                            <h4 class="update">FgoWiki Ver1.25 Web＆手册 Bug修复 活动联动</h4>

                        </div>
                        <div class="articlelist-item-body">
                            <a href="#">
                            </a>
                            <pre class="helperContent" style="background:none;">为了更适应萌新们入坑 Fgowiki更新了主页 把很多历史性问题都做了归纳 --新手引导 -手册制作共存客户端 -数据包归纳 -游戏问题总结 --图鉴列表页缓存…</pre>

                        </div>
                        <div class="articlelist-item-footer">
                            <a class="btn read" href="#">阅读全文</a>
                            <div>
                                <a href="#"><span>共存客户端</span></a>
                                <a href="#"><span>新手引导</span></a>
                            </div>
                ...
                <div class="page_navi"><a href="fate.html" class="current">1</a><a href="#">2</a><a href="#"><span class="icons_head" data-icon="5"></span></a><a href="#" class="extend" title="跳转到最后一页"><span data-icon="9" class="icons_head"></span></a></div>
                ...
                <div class="panel-list">
                    <div class="panel panel-primary TOP">
                        ...
                        <div class="panel-body">
                            <ul>
                                <li><a href="#" title="【国服攻略】『夏日! 海洋! 开拓啦! FGO 2017 Summer』详细攻略">【国服攻略】『夏日! 海洋! 开拓啦! FGO 2017 Summer』详细攻略</a> - 1.7M views</li><li><a href="#" title="【国服攻略】『魔法少女纪行～Prisma•Corps～』详细攻略">【国服攻略】『魔法少女纪行～Prisma•Corps～』详细攻略</a> - 1.4M views</li><li><a href="#" title="【国服攻略】『Fate/Accel Zero Order』详细攻略">【国服攻略】『Fate/Accel Zero Order』详细攻略</a> - 1.2M views</li><li><a href="#" title="【国服攻略】『尼禄祭再临~2017 Autumn~』详细攻略">【国服攻略】『尼禄祭再临~2017 Autumn~』详细攻略</a> - 1.1M views</li><li><a href="#" title="【国服攻略】『天魔御伽草子 鬼岛』详细攻略">【国服攻略】『天魔御伽草子 鬼岛』详细攻略</a> - 857.8K views</li><li><a href="#" title="【国服攻略】『Halloween Comeback！超极☆大南瓜村～踏上冒险之旅……～』详细攻略">【国服攻略】『Halloween Comeback！超极☆大南瓜村～踏上冒险之旅……～』详细攻略</a> - 799.7K views</li><li><a href="#" title="【国服攻略】『星之三藏亲，远赴天竺』详细攻略">【国服攻略】『星之三藏亲，远赴天竺』详细攻略</a> - 782.5K views</li><li><a href="#" title="【国服攻略】『空之境界/the garden of order』详细攻略">【国服攻略】『空之境界/the garden of order』详细攻略</a> - 750.9K views</li><li><a href="#" title="【国服攻略】『第二代是Alter亲～2017圣诞节～』攻略">【国服攻略】『第二代是Alter亲～2017圣诞节～』攻略</a> - 703.8K views</li><li><a href="#" title="【国服攻略】『达芬奇与七位赝作英灵』详细攻略">【国服攻略】『达芬奇与七位赝作英灵』详细攻略</a> - 677K views</li>						</ul>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(window).scroll(function(){
            ...
            var rightheight = $('.col-xs-12').height();
            var leftheight = $('.col-md-3').height();
            if(scrollTop>350){
